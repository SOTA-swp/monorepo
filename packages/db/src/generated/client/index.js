...
const config = {
  "generator": {
    ...
    "output": {
      "value": "/Users/sotaeguchi/Documents/1.Uni/SWP/開発/SOTA_dev/packages/db/src/generated/client",
      "fromEnvVar": null
    },
    "config": {
      "engineType": "library"
    ...
    "previewFeatures": [],
    "sourceFilePath": "/Users/sotaeguchi/Documents/1.Uni/SWP/開発/SOTA_dev/packages/db/prisma/schema.prisma",
    "isCustomOutput": true
  },
  "relativeEnvPaths": {
    "rootEnvPath": null,
  ...
  "inlineSchema": "generator client {\n  provider = \"prisma-client-js\"\n  output   = \"../src/generated/client\"\n}\n\ndatasource db {\n  provider = \"sqlite\"\n  url      = env(\"DATABASE_URL\") // .envファイルの変数を参照\n}\n\nmodel User {\n  id        Int      @id @default(autoincrement())\n  email     String   @unique\n  password  String // 本番ではハッシュ化されたパスワードを保存\n  createdAt DateTime @default(now())\n}\n\n// 今後、Yjsのルーム管理テーブルなどもここに追加していく\n// model Room { ... }\n// model Permission { ... }\n",
  "inlineSchemaHash": "38d09342554be4f14958e6b8c7bd5e4521399bdcb815c0cef0f54c08c23df7a6",
  "copyEngine": true
}
